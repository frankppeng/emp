...
<div class="show_content" id="show">
    ...
    <div class="show_list">
    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <d:forEach items="${order}" var="top">
	          <tr>
	            <td height="40" align="center">${top['order_id']}</td>
	            <td height="40" align="center">${top['order_sendname']}</td>
	            <td height="40" align="center">${top['order_sendtel']}</td>
	            <td height="40" align="center">${top['order_sendaddid']}</td>
	            <td height="40" align="center">${top['order_senddate']}</td>
	            <td height="40" align="center">${top['order_getname']}</td>
	            <td height="40" align="center">${top['order_gettel']}</td>
	            <td height="40" align="center">${top['order_getaddid']}</td>
	            <td height="40" align="center">${top['order_getdate']}</td>
	          </tr>
	      </d:forEach>
        </table>
    </div>
