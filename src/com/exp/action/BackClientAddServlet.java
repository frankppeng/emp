...
@WebServlet("/back/client/add.jhtml")
public class BackClientAddServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
         ...
         Client client=new Client(name, "0", pass, tel, idcard, sex, addressid, email);     
         Message msg=null;
         Gson gson=new Gson();
         String json=null;
